    ...
    class << self
      ...
      def validates_nip(*attr_names)
        ...
        validates_each(attr_names, configuration) do |record, attr_name, value|
          ...
          record.errors.add(attr_name, configuration[:message]) unless valid__nip? value       
        end          
      end
      ...
      def validates_regon(*attr_names)
        ...
        validates_each(attr_names, configuration) do |record, attr_name, value|
          value = record.send("#{attr_name}")          
          record.errors.add(attr_name, configuration[:message]) unless valid__regon? value       
        end          
      end
